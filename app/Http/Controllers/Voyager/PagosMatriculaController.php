...
use App\DataTables\PagosDataTables;


class PagosMatriculaController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function indexDT(PagosDataTables $dataTable)
    {
        return $dataTable->render('PagosMatricula.index');
    }
   ...
   public function pago_cliente(int $idVeterinario)
    {
        //dd($idVeterinario);
        $slug = "pagosmatricula";
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','idVeterinario'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //dd($request['veterinario']);die;
        // $data->vetrinario_id=$request['veterinario']; 
        // $data->save();
